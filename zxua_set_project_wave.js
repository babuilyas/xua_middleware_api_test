//
// ZXUA_SET_PROJECT_WAVE var: 5  struct: 0  table: 3  exception: 3
//
...
IV_WAVE_GUID            : Buffer.alloc(~size), // RAW (16) GUID of a CRM Order Object
...
const result = await client.call("ZXUA_SET_PROJECT_WAVE", parameters);
