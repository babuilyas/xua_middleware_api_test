//
// ZXUA_ADD_PARTNER var: 7  struct: 0  table: 3  exception: 3
//
...
IV_PARTNER_FCT          :           "", // CHAR (8) Partner Function
IV_PARTNER_NO           :           "", // CHAR (10) ALPHA=ALPHA Partner Number SU3=BPA
// IV_PARTNER_GUID      : Buffer.alloc(~size), // RAW (16) no text (en)
...
const result = await client.call("ZXUA_ADD_PARTNER", parameters);
