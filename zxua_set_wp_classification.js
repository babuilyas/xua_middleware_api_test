//
// ZXUA_SET_WP_CLASSIFICATION var: 5  struct: 0  table: 3  exception: 3
//
...
IV_CLASSIF              :           "", // CHAR (8) Classification Key
...
const result = await client.call("ZXUA_SET_WP_CLASSIFICATION", parameters);
