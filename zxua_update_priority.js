//
// ZXUA_UPDATE_PRIORITY var: 3  struct: 0  table: 3  exception: 3
//
...
// IV_PRIORITY          :          '1', // NUMC (1) Activity Priority
...
const result = await client.call("ZXUA_UPDATE_PRIORITY", parameters);
