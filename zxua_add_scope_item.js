//
// ZXUA_ADD_SCOPE_ITEM var: 6  struct: 0  table: 3  exception: 3
//
...
IV_SHORT_TEXT              :           "", // CHAR (40) Transaction Description
...
// EV_SCOPE_ITEM_GUID      : Buffer.alloc(~size), // RAW (16) GUID of a CRM Order Object
// EV_SCOPE_ITEM_OBJECT_ID :           "", // CHAR (10) ALPHA=ALPHA Transaction ID SU3=CRM_OBJECT_ID
...
const result = await client.call("ZXUA_ADD_SCOPE_ITEM", parameters);
