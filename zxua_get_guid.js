//
// ZXUA_GET_GUID var: 3  struct: 0  table: 2  exception: 3
//
...
IV_OBJECT_ID            :           "", // CHAR (10) ALPHA=ALPHA Transaction ID SU3=CRM_OBJECT_ID
...
const result = await client.call("ZXUA_GET_GUID", parameters);
